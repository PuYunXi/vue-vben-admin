<template>
  <div>
    <BasicTable @register="registerTable" size="small">
      <template #toolbar>
        <a-button preIcon="ant-design:plus-circle-outlined" type="primary" @click="openCreateLanguageModal"
    ...
    <CreateLanguage @register="registerCreateLanguageModal" @reload="reload" :bodyStyle="{ 'padding-top': '0' }" />
    <UpdateLanguage @register="registerUpdateLanguageModal" @reload="reload" :bodyStyle="{ 'padding-top': '0' }" />
  </div>
</template>
